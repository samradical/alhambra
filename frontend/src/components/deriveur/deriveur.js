...
import { REMOTE_ASSETS_DIR } from "../../constants/config"
...
const PABLO = [
  {
    id: "loc0",
    latitude: 37.849141,
    longitude: -122.285545,
    radius: 40,
  },
  {
    id: "loc1",
    latitude: 37.848269,
    longitude: -122.285248,
    radius: 40,
  },
  {
    id: "loc2",
    latitude: 37.847735,
    longitude: -122.286633,
    radius: 60,
  },
  {
    id: "loc3",
    latitude: 37.847527,
    longitude: -122.288117,
    radius: 40,
  },
  {
    id: "loc4",
    latitude: 37.847607,
    longitude: -122.288485,
    radius: 40,
  },
]
...
const PABLO2 = [
  {
    id: "loc0",
    latitude: 37.84963,
    longitude: -122.285749,
    radius: 10,
  },
  {
    id: "loc1",
    latitude: 37.849431,
    longitude: -122.285679,
    radius: 10,
  },
  {
    id: "loc2",
    latitude: 37.849189,
    longitude: -122.285601,
    radius: 10,
  },
  {
    id: "loc3",
    latitude: 37.848934,
    longitude: -122.285523,
    radius: 10,
  },
...
const CCA = [
  ...
  },
  {
    id: "loc1",
    latitude: 37.767321,
    longitude: -122.399985,
    radius: 10,
  },
  {
    id: "loc2",
    latitude: 37.767164,
    longitude: -122.399806,
    radius: 10,
  },
  {
    id: "loc3",
    latitude: 37.767187,
    longitude: -122.399477,
    radius: 10,
  },
  /*{ id: 'loc4', latitude: 37.848934, longitude: -122.285235, radius: 10 },*/
]
...
const HOME_AREA = [
  { id: "loc0", latitude: 51.58424, longitude: -0.106143, radius: 5 },
  {
    id: "loc1",
    latitude: 51.58428,
    longitude: -0.105853,
...
const BAY_BRIDGE = [
  {
    id: "loc0",
    latitude: 37.826881,
    longitude: -122.296759,
    radius: 1530,
  },
  {
    id: "loc1",
    latitude: 37.812367,
    longitude: -122.362789,
    radius: 1530,
  },
  {
    id: "loc2",
    latitude: 37.78717,
    longitude: -122.389178,
    radius: 1530,
  },
  {
    id: "loc3",
...
class Deriveur extends Component {
  ...
  _initDeriveur() {
    ...
    console.log(Dervieur)

    this._devriveur = new Dervieur(
      alhambra.toArray(),
      ALHAMBRA,
      {
        noVisualMap: true,
  ...
  render() {
    ...
    if (this.state.geoError) {
      return (
        <div ref="instruction" className="o-page instruc-wrapper">
          <h3>There was a problem with geolocation</h3>
          <p className="ins-tech bold small">
            Follow these instrcutions and refresh the page.
          </p>
          <p className="ins-tech detail">
            <i>iOS</i>: Settings > Privacy > Location Services >
            Safari > While Using
          </p>
          <p className="ins-tech detail">
            <i>Android</i>:{" "}
    ...
    return <div ref="deriveur" className="deriveur" />
  }
}

export default connect(
  ({ alhambra, browser, tour }) => ({
    alhambra,
    browser,
    tour,
  }),
